 ...
 */
declare type Meta<TCmpOrArgs = Args> = TCmpOrArgs extends ComponentType<any> ? ComponentAnnotations<ReactFramework, ComponentProps<TCmpOrArgs>> : ComponentAnnotations<ReactFramework, TCmpOrArgs>;
/**
 * Story function that represents a CSFv2 component example.
 *
 * @see [Named Story exports](https://storybook.js.org/docs/formats/component-story-format/#named-story-exports)
 */
declare type StoryFn<TCmpOrArgs = Args> = TCmpOrArgs extends ComponentType<any> ? AnnotatedStoryFn<ReactFramework, ComponentProps<TCmpOrArgs>> : AnnotatedStoryFn<ReactFramework, TCmpOrArgs>;
/**
 ...
 * ```
 */
declare type ComponentStory<T extends JSXElement> = ComponentStoryFn<T>;
 ...
 */
declare function composeStory<TArgs = Args>(story: Store_ComposedStory<ReactFramework, TArgs>, componentAnnotations: Meta<TArgs | any>, projectAnnotations?: ProjectAnnotations<ReactFramework>, exportsName?: string): {
 ...
 * @param [projectAnnotations] - e.g. (import * as projectAnnotations from '../.storybook/preview') this can be applied automatically if you use `setProjectAnnotations` in your setup files.
 */
declare function composeStories<TModule extends Store_CSFExports<ReactFramework>>(csfExports: TModule, projectAnnotations?: ProjectAnnotations<ReactFramework>): Omit<Store_StoriesWithPartialProps<ReactFramework, TModule>, keyof Store_CSFExports<_storybook_types.AnyFramework>>;
