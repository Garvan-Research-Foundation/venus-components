...
declare class StoryRender<TFramework extends AnyFramework> implements Render<TFramework> {
    ...
    torndown: boolean;
    constructor(channel: Channel, store: StoryStore<TFramework>, renderToScreen: Store_RenderToDOM<TFramework>, callbacks: RenderContextCallbacks<TFramework>, id: StoryId, viewMode: ViewMode, story?: Store_Story<TFramework>);
    private runPhase;
...
interface DocsContextProps<TFramework extends AnyFramework = AnyFramework> {
     ...
     */
    renderStoryToElement: (story: Store_Story<TFramework>, element: HTMLElement) => () => Promise<void>;
    /**
